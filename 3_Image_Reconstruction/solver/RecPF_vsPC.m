function [U,Out] = RecPF_vsPC(m,n,aTV,aL1,picks,B,TVtype,opts,PsiT,Psi,URange,uOrg)
...
% Wotao Yin, modified in Spring 2009; added Bregman, complex computation
% Wotao Yin, modified on Oct. 11, 2009; added a few options
% Wotao Yin, corrected a bug where "z" should be "Z"
%
% CAAM, Rice University, Copyright (2009-2010)
...
for ii = 1:maxItr
    ...
    rhs = Compute_rhs_DxtU_DytU(Wx,Wy,bx,by,(aTV*beta)); % = (aTV*beta)*(DxtU(Wx-bx)+DytU(Wy-by));
