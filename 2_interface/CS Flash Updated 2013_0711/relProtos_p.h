...
/* /opt/PV5.1/prog/parx/src/cs_flash/initMeth.c */
void initMeth _P_((void));
/* /opt/PV5.1/prog/parx/src/cs_flash/loadMeth.c */
void loadMeth _P_((const char *));
/* /opt/PV5.1/prog/parx/src/cs_flash/parsRelations.c */
...
void CompressiveModeRel _P_((void));
void RecoCompVisPar _P_((void));
void CompRatioRel _P_((void));
/* /opt/PV5.1/prog/parx/src/cs_flash/BaseLevelRelations.c */
...
void SetNewEncParam _P_((void));
void SetACQ_obj_orderForMovie _P_((void));
/* /opt/PV5.1/prog/parx/src/cs_flash/RecoRelations.c */
...
/* /opt/PV5.1/prog/parx/src/cs_flash/deriveVisu.c */
