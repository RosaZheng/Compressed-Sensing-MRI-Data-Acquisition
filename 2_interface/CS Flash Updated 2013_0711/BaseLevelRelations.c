/****************************************************************
 *
 * $Source: /pv/CvsTree/pv/gen/src/prg/methods/cs_flash/BaseLevelRelations.c,v $
 *
 ...
 * All Rights Reserved
 *
 * Compressive sensing mode added by Ming Yang, NSEI,University of Missouri
 * 
 *
...
void SetBaseLevelParam( void )
{
  ...
  /* ------------------------------------------------------------------------
     Overide encoding parameters if compressive mode is on
     ----------------------------------------------------------------------- */
...
void SetNewEncParam()
{
  ...
  {
  double GaussEnc[35] = {-0.515625, -0.40625, -0.3125, -0.296875, -0.265625, -0.234375, -0.1875, -0.171875, -0.15625, -0.140625, -0.125,-0.109375, -0.078125, -0.0625, -0.046875, -0.03125,-0.015625, 0, 0.015625, 0.03125, 0.046875, 0.0625, 0.078125, 0.109375, 0.125, 0.140625, 0.15625, 0.171875, 0.1875, 0.234375, 0.265625, 0.296875, 0.3125,0.40625 ,0.515625};
    PVM_Matrix[1] = 35;
    ACQ_size[1] =35;
    ACQ_phase_encoding_mode[1] = User_Defined_Encoding;;
    ACQ_phase_enc_start[1] = -1.0; /* set, but no used */
